...
Github repo: https://github.com/RamonReilman/growth_impact_cress
...
Om te bepalen of er een significant tussen de groei van de oplossingen en planten soort is gebruik gemaakt van de 2-way anova test, voor effect sterkte is bij deze test Fisher's eta2 berekend. Om de power te berekenen is de library pwr2 gebruikt. 
